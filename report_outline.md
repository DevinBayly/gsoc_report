...
![Size effects on Compression: The blue line indicates the median compression factor of 2.25, and the x-axis uses a log10 scale for Block size.](./Compvsoriginal.png)
